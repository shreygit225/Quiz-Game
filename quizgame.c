#include<stdio.h>//to print strings, integer, character etc on output screen
#include<conio.h>// provide console input/output
#include<ctype.h> //inbuilt functions to handle strings
#include<stdlib.h>//memory allocation , process control
#include<string.h>//declare definitions , constants, and declaration of function
void show_record();
void reset_score();
void help();
...
Ronaldo");
 ...
 {
 system("cls");
 printf("\n\nSORRY YOU ARE NOT ELIGIBLE TO PLAY THIS GAME, BETTER LUCK NEXT
TIME");
 getch();
 goto mainhome;
 }
...
Reader");
 ...
 score:
 system("cls");
 score=(float)countr*100000; //type casting operator
